...
void Cube::initVectors() {
    ...
    this->vertices.insert(this->vertices.end(), {
            ...
            //Just the inverse/opposite of the front face
            //Since its the inverse that mean its the opposite side of the shape too
             0.5f,   0.5f,  -0.5f, colors[7].red, colors[7].green, colors[7].blue, //Top Right
            -0.5f,   0.5f,  -0.5f, colors[6].red, colors[6].green, colors[6].blue, //Top Left
